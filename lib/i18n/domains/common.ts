export const commonEn = {
  ...
  CommissionModeDesc: "Choose how commissions are calculated for each sale.",
  CommissionModeAuto: "Automatic (Tier-based)",
  CommissionModeAutoDesc: "Commission is calculated automatically from tiers when a sale is recorded.",
  CommissionModeManual: "Manual (Per sale)",
  CommissionModeManualDesc: "Managers manually enter the commission amount for each sale in the commissions page.",
...
export const commonAr = {
  ...
  CommissionModeDesc: "اختر كيفية احتساب العمولات لكل صفقة.",
  CommissionModeAuto: "تلقائي (حسب الشرائح)",
  CommissionModeAutoDesc: "تُحسب العمولة تلقائياً من الشرائح عند تسجيل البيع.",
  CommissionModeManual: "يدوي (لكل صفقة)",
  CommissionModeManualDesc: "يقوم المديرون بإدخال مبلغ العمولة يدوياً لكل صفقة في صفحة العمولات.",
