export const socialInboxEn = {
  ...
  ResyncResolvedNames: "contact names resolved",
  ResyncFailed: "Resync failed.",
  ResyncPartial: "Resync partially completed — some steps failed.",
...
export const socialInboxAr = {
  ...
  ResyncResolvedNames: "أسماء جهات اتصال تم استرجاعها",
  ResyncFailed: "فشلت المزامنة.",
  ResyncPartial: "اكتملت المزامنة جزئياً — تعذّر تنفيذ بعض الخطوات.",
