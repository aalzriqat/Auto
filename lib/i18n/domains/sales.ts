export const salesEn = {
  ...
  DepositTreatmentTitle: "What happens to the reservation deposit?",
  DepositApplyToSettlement:
    "Keep it against the margin the supplier owes the dealership — the customer was never billed for the car, so the cash the dealership already holds settles part of that claim.",
  DepositRefundToCustomer: "Refund it to the customer.",
...
export const salesAr = {
  ...
  DepositTreatmentTitle: "ما مصير العربون؟",
  DepositApplyToSettlement:
    "الاحتفاظ به مقابل الهامش المستحق على المورّد — العميل لم تُصدر له فاتورة بالسيارة، فالمبلغ الذي يحتفظ به المعرض يسدّد جزءًا من تلك المطالبة.",
  DepositRefundToCustomer: "إعادته إلى العميل.",
