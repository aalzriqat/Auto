...
const dealOverviewMessages = defineBilingualMessages({
  ...
  CustodyReadOnlyNote: [
    "Shown as recorded. Custody movements are not yet posted to the books, so they are not recorded from this screen.",
    "معروضة كما سُجِّلت. حركات العهدة لا تُرحَّل إلى الدفاتر بعد، لذا لا تُسجَّل من هذه الشاشة.",
  ],
