...
describe("pull-request workflow secret boundary", () => {
  ...
  it("runs Jev shadow analysis from the immutable workflow revision", () => {
    ...
    expect(source).toContain("TYPESAFE_API_KEY: ${{ secrets.TYPESAFE_API_KEY }}");
  });
