 ...
 * one has exhausted its retries: the outbox due-work sweep selects only PENDING
 * rows, so opening a period does nothing for it, and telling someone to do that
 * sends them somewhere they cannot fix it.
 */
