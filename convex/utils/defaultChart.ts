...
export const DEFAULT_CHART: DefaultAccountDef[] = [
  ...
  },
  {
    code: "1130",
    name: "VAT Receivable",
    nameAr: "ضريبة القيمة المضافة المدينة",
    type: "ASSET",
    normalBalance: "DEBIT",
    isControlAccount: false,
    allowManualPosting: false,
    systemKey: SYSTEM_KEYS.VAT_RECEIVABLE,
  },
  {
    code: "1200",
  ...
  },
  {
    ...
    isControlAccount: false,
    allowManualPosting: true,
    systemKey: SYSTEM_KEYS.RENT_EXPENSE,
  },
  {
    code: "6810",
    ...
    isControlAccount: false,
    allowManualPosting: true,
    systemKey: SYSTEM_KEYS.UTILITIES_EXPENSE,
  },
  {
    code: "6820",
    ...
    isControlAccount: false,
    allowManualPosting: true,
    systemKey: SYSTEM_KEYS.SALARIES_EXPENSE,
  },
  {
    code: "6830",
    ...
    isControlAccount: false,
    allowManualPosting: true,
    systemKey: SYSTEM_KEYS.MARKETING_EXPENSE,
  },
  {
    code: "6840",
    name: "Office Expense",
    ...
    isControlAccount: false,
    allowManualPosting: true,
    systemKey: SYSTEM_KEYS.OFFICE_EXPENSE,
  },
  {
    code: "6850",
    name: "Professional Fees Expense",
    nameAr: "مصروف أتعاب مهنية",
    type: "EXPENSE",
    normalBalance: "DEBIT",
    isControlAccount: false,
    allowManualPosting: true,
