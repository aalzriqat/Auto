      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[560px]">
        ...
        <form onSubmit={onSubmit} className="space-y-4 pt-4">
          <div className="grid gap-2">
            <Label htmlFor="company-name">{t("Company Name" as any)}</Label>
            <Input
              id="company-name"
              required
              value={formData.name}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="grid gap-2">
              <Label htmlFor="admin-fees">{t("ExecutionFees" as any)}</Label>
              <Input
                id="admin-fees"
                type="number"
          ...
          <DialogFooter>
            ...
            <Button
              type="submit"
              disabled={isLoading || loadedCustomerStatuses === undefined}
            >
