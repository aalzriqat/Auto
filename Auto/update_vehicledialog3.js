...
// Handle the onSubmit function and Add upload handlers
// We completely replace the old onSubmit block
const oldOnSubmitBlock = `  const onSubmit = async (values: VehicleFormValues) => {
...
content = content.replace(oldOnSubmitBlock, newHandlers.trim());
...
console.log('VehicleDialog.tsx updated securely');
