...
- `Convex Create Component Skill` --conceptually_related_to--> `Convex Auth Reference`  [INFERRED]
...
Cohesion: 0.24
Nodes (17): Claude Convex Migration Helper Skill, Convex Migration Helper Skill, Convex Quickstart Skill, Widen-Migrate-Narrow Pattern, Convex Performance Audit Agent, Convex Quickstart, computedHash, computedHash (+9 more)
...
Cohesion: 0.26
Nodes (8): Switch, PERMISSION_GROUPS, RolePermissionsEditor(), AccordionContent, AccordionItem, AccordionTrigger, Checkbox, Switch
...
### Community 40 - "Env Config & Validation"
Cohesion: 0.33
Nodes (3): _env, envSchema, nextConfig
...
### Community 52 - "Auth Config & README"
Cohesion: 0.10
...
Cohesion: 0.10
Nodes (19): 1.1 — SECURITY AUDIT CHECKLIST, 1.2 — PRODUCTION READINESS CHECKLIST, 1.3 — CODE QUALITY & MAINTAINABILITY CHECKLIST, 2.1 — Critical Issues (Must fix before any production deployment), 2.2 — High Priority Issues (Fix before launch or within first sprint), 2.3 — Medium Priority Issues (Fix within first month), 2.4 — Low Priority & Informational (Fix when time allows), 2.5 — Production Readiness Scorecard (+11 more)
...
Cohesion: 0.18
Nodes (13): Class-based Client Wrappers, Convex Performance Audit Skill, Function Budget, Digest Tables Pattern, Hot Path Rules, Migration Patterns Reference, Migrations Component (@convex-dev/migrations), OCC Conflict Resolution (+5 more)
...
Cohesion: 0.17
Nodes (12): Claude Convex Advanced Patterns, Claude Convex Create Component Skill, Claude Convex Hybrid Components, Convex Advanced Component Patterns, Convex Hybrid Components Reference, Convex Local Components Reference, Convex Packaged Components Reference, Advanced Component Patterns (+4 more)
...
Cohesion: 0.22
Nodes (8): 1. Create Backend Environment Validator, 2. Implement the Validator in Critical Paths, 3. Frontend Env File Cleanup, Definition of Done, How to Test This Phase, Objective, Phase 3 — Configuration & Environment Hardening, Step-by-Step Instructions

### Community 138 - "Community 138"
Cohesion: 0.22
Nodes (8): 1. Setup Financial Logic Unit Tests, 2. Setup Convex Backend Integration Tests, 3. Add Testing into the CI Pipeline, Definition of Done, How to Test This Phase, Objective, Phase 4 — Test Coverage Foundation, Step-by-Step Instructions

### Community 139 - "Community 139"
Cohesion: 0.22
Nodes (8): 1. Define New Rate Limit Categories, 2. Apply Rate Limits to Expensive Read Queries, 3. Apply Rate Limits to Other Mutations, Definition of Done, How to Test This Phase, Objective, Phase 5 — API Rate Limiting & DoS Protection, Step-by-Step Instructions
...
Cohesion: 0.25
Nodes (8): Auth0 Reference, Clerk Reference, Convex Authentication Setup, Convex Setup Auth Agent, Auth0 Reference, Clerk Reference, Convex Auth Reference, WorkOS AuthKit Reference
...
Cohesion: 0.25
Nodes (7): 1. Fix the Cron Job Full Table Scan, 2. Fix N+1 Queries in `convex/reports.ts`, Definition of Done, How to Test This Phase, Objective, Phase 1 — Critical Performance & Indexing, Step-by-Step Instructions

### Community 144 - "Community 144"
Cohesion: 0.29
Nodes (6): 1. Codebase Topology Map, 2. Tech Stack Summary, 3. Executive Summary, 4. Production Readiness Scorecard, 5. Top 5 Risks if Deployed Today, Executive Summary

### Community 145 - "Community 145"
Cohesion: 0.29
Nodes (4): name, private, version, config

### Community 146 - "Community 146"
Cohesion: 0.33
Nodes (5): 2.1 — Critical Issues (Must fix before any production deployment), 2.2 — High Priority Issues (Fix before launch or within first sprint), 2.3 — Medium Priority Issues (Fix within first month), 2.4 — Low Priority & Informational (Fix when time allows), Full Codebase Audit Findings
...
Cohesion: 0.33
Nodes (5): Migrate to Default Branch, add, list, migrateToDefaultBranch, update
...
Cohesion: 0.50
Nodes (3): PaymentType, SalesWizardProps, WizardData
