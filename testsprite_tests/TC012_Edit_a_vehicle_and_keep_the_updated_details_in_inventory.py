...
async def run_test():
    ...
    try:
        ...
        # -> Fill the 'Email address or username' field with username 'alaajarad', fill the 'Password' field with the provided password, then click the 'Continue' button to sign in.
